"""
Django settings for MyPortfolioDjango project.
...
ROOT_URLCONF = 'MyPortfolioDjango.urls'
...
WSGI_APPLICATION = 'MyPortfolioDjango.wsgi.application'
...
GRAPHENE = {
    "SCHEMA": "MyPortfolioDjango.schema.schema",
    "MIDDLEWARE": [
        "MyPortfolioDjango.graphQL.CustomJSONWebTokenMiddleware",
    ],
}
